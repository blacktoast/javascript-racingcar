...
### 진행상황
[x] 자동차 이름 입력을 받는다
-[x] 입력시 5글자 초과시 alert창
-[x] 공백 입력시 alert창
[x] 확인 버튼을 누르면 car-container 태그에 참가한 차들을 렌더링한다
[] 시도횟수를 받는다
-[] 시도횟수가 음수가 아닐수있게 검증

[] 시도횟수 입력후 확인 버튼 누를시 게임 시작
-[] 자동차 입력값을 검증- 자동차확인 버튼클릭 렌더링 기능 제거 생각\*\
-[] 게임실행
--[x] 각 자동차 객체에 현재 위치 할당
--[x] 자동차 진행로직구현- random으로 0-9 4이상일시 전진
--[] 전진할떄 렌더링
--[] 
